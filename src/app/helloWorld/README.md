...
- `helloWorld.js` - defines the module.
- `helloWorld.less` - module-specific styles; this file is imported into
  `src/less/main.less` manually by the developer.
- `helloWorld.spec.js` - module unit tests.
- `helloWorld.tpl.html` - the route template.
